    ...
    <>
          ...
          {entry.expertEvaluation && (
            <Box mt={4}>
              <Text fontSize="lg" fontWeight="bold">
                {entry.expertEvaluation.expertName || 'Brak eksperta'}
              </Text>
              <Text>
                <img
                  src={entry.expertEvaluation.expertBadge || 'Brak Odznaka:'}
                  alt="Badge"
                  width="50"
                />
              </Text>
              <Text>
                {entry.expertEvaluation.expertMessage || 'Brak wiadomości'}
              </Text>
              <Text>
      ...
      >
        ...
        <Textarea
          ...
          mt={2}
        />
        <Button onClick={sendMessage} colorScheme="green" mt={2}>
          Wyślij
        </Button>
        {success && (
