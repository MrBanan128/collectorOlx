      ...
      >
        ...
        <Flex direction={flexDirection} gap={8} align="stretch">
          ...
          >
            ...
            {/* Tekst */}
            <Text fontSize="lg">
              Zrób jak najdokładniejsze zdjęcia przedmiotu, który chcesz wycenić
              bez nich wycena będzie ona utrudniona.
            </Text>
          </Box>
          ...
          >
            ...
            <Text fontSize="lg">
              ...
              wczesniej wykonane zdjęcia i zadbaj o jak dokładniejszy opis oraz
              wybierz kategorię i podkategorię swojego przedmiotu pomoże ona
              ekspertom z wiedzą w konkretnych kolekcjach szybciej znaleźć i
              wycenić twój przedmiot.
            </Text>
          </Box>
          ...
          >
            ...
            {/* Tekst */}
            <Text fontSize="lg">
              W razie wątpliwości skorzystaj z możliwości wysłania wiadomości do
              eksperta z prośbą o dokładniejsze wyjaśnienie czynników, które
              wpłynęły na wycenę.
            </Text>
          </Box>
        </Flex>
        ...
        <Box mt={20} textAlign="center">
          ...
          <VStack spacing={6} maxW="800px" mx="auto">
            <Text fontSize="14px">
              🏆 Nasi eksperci mają wieloletnie doświadczenie w wycenie antyków
              i przedmiotów kolekcjonerskich.
            </Text>
            <Text fontSize="14px">
